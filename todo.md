...
- [x] Build 266（提交 `e38e5b36`）已通过 Xcode 编译、Apple 校验并上传 TestFlight；Delivery UUID `47b5ad65-a6d3-4f47-9d54-b522984f4825`
...
- [x] 增加群主/群管理员权限：仅群主或管理员可改群名/公告、管理员可审核入群，群主可设置管理员、取消管理员和转让群主
- [x] 增加群二维码生成、扫码预览和入群流程；支持直接入群或提交群主/管理员审批
- [x] 群资料支持多选群成员批量禁言与解除禁言；后端拒绝被禁言成员发送群消息
