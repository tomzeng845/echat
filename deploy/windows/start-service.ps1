...
foreach ($name in @("MONGODB_URI", "MONGODB_DATABASE", "JWT_SECRET", "ADMIN_BOOTSTRAP_PASSWORD", "ADMIN_SECRET_ENCRYPTION_KEY", "SEED_INVITE_CODE", "CORS_ALLOWED_ORIGINS", "TURN_URLS", "TURN_SECRET", "SFU_URL", "FCM_PROJECT_ID", "FCM_SERVICE_ACCOUNT_JSON")) {
