...
foreach ($name in @("MONGODB_URI", "MONGODB_DATABASE", "MONGODB_DIRECT_CONNECTION", "JWT_SECRET", "ADMIN_BOOTSTRAP_PASSWORD", "ADMIN_SECRET_ENCRYPTION_KEY", "ADMIN_TOTP_SECRET", "SEED_INVITE_CODE", "CORS_ALLOWED_ORIGINS", "ECHAT_HTTPS_CERT_PATH", "ECHAT_HTTPS_CERT_PASSWORD", "ECHAT_HTTPS_PORT", "TURN_URLS", "TURN_SECRET", "SFU_URL", "FCM_PROJECT_ID", "FCM_SERVICE_ACCOUNT_JSON", "APNS_TEAM_ID", "APNS_KEY_ID", "APNS_BUNDLE_ID", "APNS_PRIVATE_KEY", "APNS_USE_SANDBOX")) {
