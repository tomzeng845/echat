...
if (overview.version !== "0.8.3" || overview.metrics.users < 1)
...
console.log(
  `ADMIN_083_OK modules=${moduleCases.length} pages=24 users=${users.total} audits=${audits.length} role_guard=403 menu_anchor=button outside_click=closed viewports=1440x900,390x844`
);
